...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { latitude: @attraction.latitude, longitude: @attraction.longitude, name: @attraction.name, street: @attraction.street, town_id: @attraction.town_id } }
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { latitude: @attraction.latitude, longitude: @attraction.longitude, name: @attraction.name, street: @attraction.street, town_id: @attraction.town_id } }
