...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { description: @town.description, latitude: @town.latitude, longitude: @town.longitude, name: @town.name, state: @town.state } }
    end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { description: @town.description, latitude: @town.latitude, longitude: @town.longitude, name: @town.name, state: @town.state } }
